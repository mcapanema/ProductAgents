...
def test_risk_assessment_defaults_not_failed():
    from productagents.core.models import RiskAssessment
...
def test_reflection_holds_outcome_fields():
    from productagents.core.models import Reflection
...
def test_judge_finding_and_verdict_construct():
    from productagents.core.models import JudgeFinding, JudgeVerdict
